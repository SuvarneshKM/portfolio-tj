...
function Banner() {
    return (
        <div className="relative my-auto py-[108px] lg:py-[144px] max-w-[887px] mx-auto px-[15px] sm:px-[25px] text-left lg:text-center text-dark bg-light ">
            ...
            <p className="text-[20px] font-medium pt-[4px] pb-[4px]">Hello, I'm <span className="text-accent">Akhil T J</span>.</p>
            <h1 className="text-[40px] lg:text-[48px] font-extrabold">Inquisitive Junior Designer,
                Specialized in UI/UX,</h1>
            <p className="text-[20px] font-medium pt-[4px] lg:pr-20 lg:pl-20">
            ...
            <div className="hidden lg:inline-flex pt-[40px]">
