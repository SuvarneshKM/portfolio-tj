        ...
        <>
            ...
            <main className="max-w-[1240px] mx-auto px-[16px] py-[16px] text-dark">
                <section className="flex flex-col lg:flex-row lg:pt-[145px] pt-[80px] ">
                    ...
                    <div className="pt-[24px] lg:pt-0 lg:pl-[140px]">
                        <h4 className="lg:text-[32px] text-left text-[24px] font-semibold ">Hello, I’m Akhil T J</h4>
                        <p className="lg:pt-[12px] pt-[16px] text-[20px] text-left font-normal">I’m a self taught <span className="text-accent">freelance</span> designer,
                        ...
                        <div className="pt-[16px] lg:pt-[24px] lg:hidden">
                        ...
                        <div className=" pt-[32px] lg:hidden">
                        ...
                        <div className=" pt-[40px] lg:pt-[52px] flex lg:flex-row flex-col lg:space-x-[24px] space-y-[24px] lg:space-y-0">
                ...
                <section className="pt-[100px] lg:pt-[200px]">
                    <h2 className="lg:text-[36px] text-[28px] text-left lg:text-center font-extrabold text-accent">Experience</h2>
                    <div className="flex lg:flex-row flex-col-reverse lg:pt-[96px] pt-[40px]">
                        <div className="flex flex-col pt-[24px] lg:pt-0 lg:pr-[140px]">
                            <h4 className="text-left text-[32px] font-semibold">Freelance Designer - Self Employed</h4>
                            <p className="pt-[16px] text-[20px] text-left font-normal ">Taking design briefs to understand requirements. Conceptualising and developing design concepts, graphics and layouts. Designing and producing collateral in accordance with brand guidelines. Presenting ideas, concepts and design solutions to various stakeholders and incorporating their feedback into the final design.
                            </p>
                            <ul className="list-disc pl-10 pt-[24px] lg:pt-[40px] text-[20px] font-normal flex-grow">
                                <li className="p-1"><span className="text-accent">8+</span> Happy Clients</li>
                                <li className="p-1"><span className="text-accent">25+</span> Community Works</li>
                                <li className="p-1">Open to <span className="text-accent">Learning</span></li>
                            </ul>
                        </div>
                        <div className="relative aspect-h-1 aspect-w-1 lg:hidden flex-shrink lg:flex-shrink-0">
                            <Image
                                src='/About/Frame-7058.png'
                                layout="fill"
                                objectFit="cover"
                            />
                        </div>
                    ...
                    <div className="flex lg:flex-row-reverse flex-col-reverse lg:pt-[172px] pt-[65px]">
                        <div className="flex flex-col pt-[24px] lg:pt-0 lg:pl-[140px]">
                            <h4 className="text-left text-[32px] font-semibold">Creative Lead - TinkerHub CUCEK</h4>
                            <p className="pt-[16px] text-[20px] text-left font-normal ">A community of tinkerers, makers, policy geeks & students, working towards mapping and empowering people who share a passion to innovate.
                            </p>
                            <ul className="list-disc pl-10 pt-[24px] lg:pt-[40px] text-[20px] font-normal flex-grow">
                ...
                <section className="pt-[100px] lg:pt-[200px]">
                    <h2 className="lg:text-[36px] text-[28px] text-left lg:text-center font-extrabold text-accent">Tools & Skills</h2>
                    <div className="flex flex-col-reverse lg:flex-row pt-[40px] lg:pt-[80px] lg:space-x-[178px]">
                        <div className="flex flex-col pt-[40px] lg:pt-0">
                            <h4 className="text-left text-[24px] lg:text-[32px] font-semibold">Tools</h4>
                            <div className="space-y-[16px] flex flex-col pt-[24px]">
                                <div className="flex flex-row justify-between lg:space-x-[195px]">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Figma</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Adobe XD</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-lightborder lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                    </div>
                                </div>
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Adobe Photoshop</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Canva</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Miro</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-lightborder  lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Trello</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Notion</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">MS Word</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-lightborder  lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Git/Github</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-lightborder  lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                        ...
                        <div className="flex flex-col pt-[40px] lg:pt-0">
                            <h4 className="text-left text-[24px] lg:text-[32px] font-semibold">Skills</h4>
                            <div className="space-y-[16px] flex flex-col pt-[24px]">
                                <div className="flex flex-row justify-between lg:space-x-[195px]">
                                    <span className="lg:text-[20px] text-[18px] font-normal">User Interface Design</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">User Experience Design</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Design System</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Wireframing</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Rapid Prototyping</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="lg:text-[20px] text-[18px] font-normal">Design Thinking</span>
                                    <div className="flex flex-row lg:space-x-[16px] space-x-[8px]">
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                                        <button className="border rounded border-accent bg-accent lg:h-[18px] lg:w-[18px] h-[14px] w-[14px]" />
                ...
                <section className="pt-[100px] lg:pt-[200px]">
                    <h2 className="lg:text-[36px] text-[28px] text-left lg:text-center font-extrabold text-accent">Blog & Writeups</h2>
                    <div className="flex flex-col lg:flex-row-reverse lg:pt-[80px] pt-[40px]">
                        <div className="relative lg:h-[500px] lg:w-[500px] lg:max-w-[500px] flex-shrink lg:flex-shrink-0">
                            <Image
                                src='/About/Group-7083.png'
                                layout="fill"
                                objectFit="cover"
                                className=""
                            />
                        ...
                        <div className="flex flex-col pt-[24px] lg:pt-0 lg:pr-[178px]">
                            <h4 className="lg:text-[32px] text-left text-[24px] font-semibold">Lorem ipsum dolor sit amet, consectetur</h4>
                            <p className="pt-[16px] text-[20px] text-left font-normal ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id lectus nulla euismod sit convallis nisi eu tellus aliquam. At nisl convallis arcu, nulla donec et vel tellus venenatis.
                            </p>
                   ...
                   rounded">
                    ...
                    <div className="flex flex-col lg:flex-row lg:pt-[140px] pt-[64px] space-x-0 lg:space-x-[178px]">
                        <div className="relative lg:h-[500px] lg:w-[500px] lg:max-w-[500px] flex-shrink lg:flex-shrink-0">
                            <Image
                                src='/About/Group-7084.png'
                                layout="fill"
                                objectFit="cover"
                                className=""
                            />
